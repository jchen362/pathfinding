...
I had trouble visualizing how these pathfinding algorithms explored each node so I decided to create a visualizer to help me understand better. The explored nodes are in green while the yellow node displays the path. Numbered nodes are weighted nodes and gray ones are walls.
